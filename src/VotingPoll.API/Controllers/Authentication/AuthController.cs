...
public class AuthController : ControllerBase
{
    ...
    public async Task<ActionResult> ResendVerification([FromBody] AuthDto.ResendVerificationRequest request)
    {
    ...
    public async Task<ActionResult> ForgotPassword([FromBody] AuthDto.ForgotPasswordRequest request)
    {
    ...
    public async Task<ActionResult> ResetPassword([FromBody] AuthDto.ResetPasswordRequest request)
    {
